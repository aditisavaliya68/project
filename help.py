...
class Help:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="HELP DESK",font=("times new roman",38,"bold"),fg="white",bg="brown") 
        ...
        dev_lable=Label(f_lbl,text="Email : ktopiya768@rku.ac.in",font=("times new roman",19,"bold"),bg="white",fg="blue")
