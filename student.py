...
#button frames ..............................
        ...
        save_btn=Button(btn_frame,text="SAVE",command=self.add_data,width=14,font=("times new roman",12,"bold"),bg="green",fg="black")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_data,text="TAKE PHOTO SAMPLE",width=30,font=("times new roman",12,"bold"),bg="green",fg="white")
        ...
        search_btn=Button(search_frame,text="Search",width=14,font=("times new roman",12,"bold"),bg="green",fg="white")
