...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET",font=("times new roman",38,"bold"),fg="white",bg="blue") 
        ...
        b5_1 = Button(self.root,text='CLICK HERE TO TRAIN DATA',command=self.train_classifier, cursor="hand2",font=("times new roman", 30 , "bold"), bg="blue", fg="white")
